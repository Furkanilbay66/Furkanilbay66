...
║  > Loading profile: Furkan İlbay                                 ║
║  > Status: [ ACTIVE ]  Role: [ FULL STACK + GAME DEV ]          ║
...
───   ────────────────────────────────────────────────────────────────
001   Full Stack Web Uygulaması       React + .NET Core      🟢 RUNNING
002   Unity 2D Oyun Projesi           C# + Unity             🟡 IN DEV
...
╔══════════════════════════════════════════════════════════════════╗
║  [  SESSION END  ]                                               ║
║  Uptime: Çok uzun zamandır kod yazıyorum                        ║
║  Next task: Yeni bir şey öğrenmek                               ║
║  > Görüşmek üzere! 👾                                           ║
╚══════════════════════════════════════════════════════════════════╝
```
